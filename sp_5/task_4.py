"""
Solve the problem of finding the tangent of the angle alpha given 
the sine of alpha and the cosine of alpha and add event logging to the "app.log" file.
...
In the event that cosine alpha = 0, logging should be with the "warning" level 
and the notification: "The cosine of the angle alpha = 0. The tangent is not defined.".
...
def findingTangent(sin_alpha, cos_alpha):
    ...
    if isinstance(cos_alpha, str) or isinstance(sin_alpha, str):
        ...
        tangent = sin_alpha / cos_alpha
        logging.debug(f"The value of the tangent of the angle alpha is found = {tangent}")
        return tangent
